...
export const TSH_INSTRUMENTO_CSS = `
  ...
  .tsh-badge--armed { background: var(--shs-warn-bg); color: var(--shs-warn); font-family: var(--shs-font-mono); }
  ...
  .tsh-btn--sm { min-height: 30px; padding: 0 10px; font-size: 12.5px; border-radius: 8px; }
  ...
  .tsh-runbtn:disabled { opacity: .35; cursor: default; }

  /* ---------- Chave liga/desliga ---------- */
  .tsh-switch { position: relative; display: inline-flex; width: 36px; height: 20px; flex-shrink: 0; cursor: pointer; }
  .tsh-switch input { position: absolute; inset: 0; opacity: 0; margin: 0; cursor: pointer; }
